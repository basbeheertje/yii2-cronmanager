...
?>
<div class="col-lg-6">
    <h2><?php echo Yii::t('cron','Import'); ?></h2>
    <form method="post" id="parse_crontab_form">
        <div class="form-group">
            <label for="crontab"><?php echo Yii::t('cron','Paste crontab content'); ?></label>
...
<div class="col-lg-6">
    <h2><?php echo Yii::t('cron','Export'); ?></h2>
    <form class="form-inline" id="export_form">
        <div class="form-group">
            <label class="control-label" for="php"><?php echo Yii::t('cron','Path to PHP'); ?></label>
            <input type="text" class="form-control" name="php" id="php" value="/usr/bin/php" style="width: 100px;">
        </div>
        <div class="form-group">
            <label class="control-label" for="folder"><?php echo Yii::t('cron','Path to folder'); ?></label>
            <input type="text" class="form-control" name="folder" id="folder" value="/home/project/">
        </div>
        <div class="form-group">
            <label class="control-label" for="file"><?php echo Yii::t('cron','php file'); ?></label>
