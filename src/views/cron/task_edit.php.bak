...
<form method="post">
    <div class="col-lg-6">
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control" id="status">
                <option value="active"><?php echo \Yii::t('app','Active'); ?></option>
                <option value="inactive"<?php if ('inactive' == $task->status) echo ' selected' ?>><?php echo \Yii::t('app','Inactive'); ?></option>
            </select>
        </div>
        <div class="form-group">
            <label for="comment"><?php echo \Yii::t('app','Comment'); ?></label>
    ...
    <div class="col-lg-6">
        <div class="form-group">
            <label for="times"><?php echo \Yii::t('app','Predefined intervals'); ?></label>
        ...
        <div class="form-group">
            <label for="time"><?php echo \Yii::t('app','Time'); ?></label>
...
+------------------------- min (0 - 59)
        ...
        <h4><?php echo \Yii::t('app','Next runs'); ?></h4>
